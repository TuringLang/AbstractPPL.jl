...
@testset "varname/optic.jl" verbose = true begin
    @testset "pretty-printing" begin
        ...
        @test string(@opticof(_[begin + 1])) == "Optic([DynamicIndex(begin + 1)])"
        @test string(@opticof(_[end - 1])) == "Optic([DynamicIndex(end - 1)])"
        @test string(@opticof(_.a[begin:end].b)) == "Optic(.a[DynamicIndex(begin:end)].b)"
