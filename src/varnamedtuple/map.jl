...
"""
function AbstractPPL.subset(parent_vnt::VarNamedTuple, vns)
    return mapfoldl(
        identity,
...
```jldoctest
julia> using AbstractPPL: VarNamedTuple

julia> using BangBang: setindex!!

julia> using AbstractPPL.VarNamedTuples: apply!!
