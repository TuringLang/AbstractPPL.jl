...
### Traces and probability expressions
...
All sampleable model instances are assumed to implement [the `AbstractMCMC` interface](https://turinglang.org/AbstractMCMC.jl/stable/api/).
